local Lib = loadstring(game:HttpGet("https://raw.githubusercontent.com/ZlvXs/zQLibs/main/Dirt%20UI/Blue.lua",true))() -- You can change the Toggle Keybind (Default is F6)
local Table = {}
...
x:Search(Color3.fromRGB(0,0,255))--  Searcher if you have a lot of things
x:Section("Section 2")
