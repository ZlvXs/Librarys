local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/ZlvXs/zQLibs/main/Cattoware%20UI/Purple.lua"))()
...
ColorToggle:AddColorpicker(Color3.fromRGB(127,0,255), function(ztx)
   print(ztx)   
end)
